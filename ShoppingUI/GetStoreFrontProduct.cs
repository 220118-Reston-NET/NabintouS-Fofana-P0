...
{
    public class GetStoreFrontProducts : IMenu
    {
        private List<StoreFront> _listOfStoreFront;
        private IStoreFrontBL _storefrontBL;
        public GetStoreFrontProducts(IStoreFrontBL p_storefrontBL)
        {
            ...
            switch (userInput)
            {
                ...
                case "1":
                    ...
                    try
                    {
                        ...
                        List<Product> listOfProduct = _storefrontBL.GetProductByStoreFrontID(storeID);
